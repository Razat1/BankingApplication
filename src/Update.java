...
public class Update {
        ...
        protected static boolean isBusinessAccount (AccessAccount.UserDetails userAccount){
            return "Business".equalsIgnoreCase(userAccount.getAccountType());
        }

        // Helper method to check if the account is an ISA account
        protected static boolean isISAAccount (AccessAccount.UserDetails userAccount){
